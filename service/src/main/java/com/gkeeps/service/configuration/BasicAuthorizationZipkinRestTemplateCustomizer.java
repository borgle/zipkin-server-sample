package com.gkeeps.gateway.configuration;
...
public class BasicAuthorizationZipkinRestTemplateCustomizer extends DefaultZipkinRestTemplateCustomizer {
    private final ZipkinProperties zipkinProperties;

    public BasicAuthorizationZipkinRestTemplateCustomizer(ZipkinProperties zipkinProperties) {
